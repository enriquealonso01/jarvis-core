...
SUITES="s1-harness-test s2-task-create-test s3-routing-test s3b-split-test s3c-context-test
        ...
        debug-notes-index-test s30-chunk-test s30-retrieval-test s30-dump-test s30-extract-test s30-index-artifact-test s30-which-tier-test s30-every-type-test s30-preference-test s30-harness-memory-test s30-restore-test
        no-test-litter-test"
