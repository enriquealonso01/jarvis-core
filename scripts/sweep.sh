...
SUITES="s1-harness-test s2-task-create-test s3-routing-test s3b-split-test s3c-context-test
        ...
        s11-recovery-test s12-isolation-test s12-privdrop-test s12b-router-test s12b-canary-test s12b-reauth-test s12c-live-faults-test s13-home-test s14-live-detail-test
